...
class MitigationInterval:
    color: str
    id: UUID
    mitigation_value: List[float]
    name: str
    time_range: DateRange

    def __init__(self, color: str, id: UUID, mitigation_value: List[float], name: str, time_range: DateRange) -> None:
        self.color = color
        self.id = id
    ...
    def from_dict(obj: Any) -> 'MitigationInterval':
        ...
        id = UUID(obj.get("id"))
        mitigation_value = from_list(from_float, obj.get("mitigationValue"))
    ...
    def to_dict(self) -> dict:
        ...
        result["mitigationValue"] = from_list(to_float, self.mitigation_value)
...
class EpidemiologicalData:
    ...
    def __init__(self, infectious_period: float, latency_time: float, length_hospital_stay: float, length_icu_stay: float, overflow_severity: float, peak_month: int, r0: List[float], seasonal_forcing: float) -> None:
    ...
    def from_dict(obj: Any) -> 'EpidemiologicalData':
        ...
        r0 = from_list(from_float, obj.get("r0"))
    ...
    def to_dict(self) -> dict:
        ...
        result["r0"] = from_list(to_float, self.r0)
...
class PopulationData:
    ...
    def __init__(self, cases: str, country: str, hospital_beds: int, icu_beds: int, imports_per_day: float, initial_number_of_cases: int, population_served: int) -> None:
        self.cases = cases
        self.country = country
    ...
    def from_dict(obj: Any) -> 'PopulationData':
        ...
        return PopulationData(cases, country, hospital_beds, icu_beds, imports_per_day, initial_number_of_cases, population_served)
